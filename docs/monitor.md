...
docker run --rm --name cendor-monitor -p 3000:3000 -p 4317:4317 -p 4318:4318 ghcr.io/cendorhq/cendor-monitor:0.9.8
...
current v0.9.8 — the two-doors-split UX (two stores, path-routed Libraries | SDK modes, the SDK
